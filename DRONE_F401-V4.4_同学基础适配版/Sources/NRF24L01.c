...
static uint8_t TX_ADDRESS[TX_ADR_WIDTH]= {0x11,0x22,0x33,0x44,0x55};  //本地地址
static uint8_t RX_ADDRESS[RX_ADR_WIDTH]= {0x11,0x22,0x33,0x44,0x55};  //接收地址RX_ADDR_P0 == RX_ADDR
...
{
  HAL_GPIO_WritePin(NRF24L01_CE_GPIO_Port, NRF24L01_CE_Pin, GPIO_PIN_RESET);
  NRF24L01_Write_Buf(NRF24L01_WRITE_REG+TX_ADDR,(uint8_t*)TX_ADDRESS,TX_ADR_WIDTH);
  NRF24L01_Write_Buf(NRF24L01_WRITE_REG+RX_ADDR_P0,(uint8_t*)RX_ADDRESS,RX_ADR_WIDTH);
  NRF24L01_Write_Reg(NRF24L01_WRITE_REG+EN_AA,0x00);
  NRF24L01_Write_Reg(NRF24L01_WRITE_REG+SETUP_RETR,0x00);
  NRF24L01_Write_Reg(NRF24L01_WRITE_REG+RF_CH,NRF_CHANNEL);
...
{
    NRF24L01_SetChannelAddress(NRF_CHANNEL, addr);
}
...
void NRF24L01_SetChannelAddress(uint8_t channel, const uint8_t *addr)
{
    ...
    HAL_GPIO_WritePin(NRF24L01_CE_GPIO_Port, NRF24L01_CE_Pin, GPIO_PIN_RESET);
    NRF24L01_Write_Buf(NRF24L01_WRITE_REG + RX_ADDR_P0, RX_ADDRESS, 5);
    NRF24L01_Write_Buf(NRF24L01_WRITE_REG + TX_ADDR, TX_ADDRESS, 5);
    NRF24L01_Write_Reg(NRF24L01_WRITE_REG + RF_CH, NRF_CHANNEL);
    NRF24L01_Write_Reg(NRF24L01_WRITE_REG + STATUS, 0x70);
