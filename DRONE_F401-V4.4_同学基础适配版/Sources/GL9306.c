...
#define b_updata_uret uart2_flag   //¹âÁ÷Êý¾Ý¸üÐÂ±êÖ¾
...
//uint8_t b_updata_uret;//¹âÁ÷Êý¾Ý¸üÐÂ±êÖ¾
uint8_t pos_flag;
...
{
  uint8_t Check_sum = 0;
  static int16_t flow_x,flow_y,sum_x,sum_y;
  ...
  if(UartRxOpticalFlow[0]==0xfe)//Ð£ÑéÍ·
  {
    ...
    {    
      ...
      { flow_cnt=0;
        ...
        printf("nx=%4d,\t ny=%4d,\tsumx=%6d,\tsumy=%6d\r\n",flow_x,flow_y,sum_x,sum_y);
      }
